                    ...
                    <div class="center">
                        ...
                        <div class="lt-row row">
                            ...
                            <div class="lt-col col m4 s12">
                                ...
                                <h5>Coding</h5>
                                <p>When we develop our projects we try stricly to </p>
                            </div>
                            <div class="lt-col col m4 s12">
                                <i class="large pe-7s-news-paper primary-color-text"></i>
                                <h5>Templates</h5>
                                <p>We have made more thatn 5+ templates which can be bouth and used for all kind of websites. Just look in our Envalo account.</p>
                            </div>
                        </div>
                    </div>
